...
def ExtractFeaturesForDir(args, tmpdir, dir_, prefix):
    for file in os.listdir(dir_):
            extract(os.path.join(dir_, file))
    ...
    # command = [sys.executable, './code2vec/HTMLExtractor/utils.py', '-dir', dir_]
    # # print command
    # # os.system(command)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-maxlen", "--max_path_length", dest="max_path_length", required=False, default=8) # not implemented for html extractor?
    parser.add_argument("-maxwidth", "--max_path_width", dest="max_path_width", required=False, default=2) # not implemented for html extractor?
    parser.add_argument("-threads", "--num_threads", dest="num_threads", required=False, default=64) # not implemented for html extractor?
    parser.add_argument("-j", "--jar", dest="jar", required=False) # not needed for html extractor
