...
CLASSIFIERS = {
    'addressbook': ["trained_classifiers/within-apps-addressbook-svm-rbf-doc2vec-distance-content-tags.sav",
                    "trained_classifiers/within-apps-addressbook-svm-rbf-dom-rted.sav",
                    "trained_classifiers/within-apps-addressbook-svm-rbf-visual-pdiff.sav"],
    'claroline': ["trained_classifiers/within-apps-claroline-svm-rbf-doc2vec-distance-content-tags.sav",
                  "trained_classifiers/within-apps-claroline-svm-rbf-dom-rted.sav",
                  "trained_classifiers/within-apps-claroline-svm-rbf-visual-pdiff.sav"],
    'dimeshift': ["trained_classifiers/within-apps-dimeshift-svm-rbf-doc2vec-distance-content-tags.sav",
                  "trained_classifiers/within-apps-dimeshift-svm-rbf-dom-rted.sav",
                  "trained_classifiers/within-apps-dimeshift-svm-rbf-visual-pdiff.sav"],
    'mantisbt': ["trained_classifiers/within-apps-mantisbt-svm-rbf-doc2vec-distance-content-tags.sav",
                 "trained_classifiers/within-apps-mantisbt-svm-rbf-dom-rted.sav",
                 "trained_classifiers/within-apps-mantisbt-svm-rbf-visual-pdiff.sav"],
    'mrbs': ["trained_classifiers/within-apps-mrbs-svm-rbf-doc2vec-distance-content-tags.sav",
             "trained_classifiers/within-apps-mrbs-svm-rbf-dom-rted.sav",
             "trained_classifiers/within-apps-mrbs-svm-rbf-visual-pdiff.sav"],
    'pagekit': ["trained_classifiers/within-apps-pagekit-svm-rbf-doc2vec-distance-content-tags.sav",
                "trained_classifiers/within-apps-pagekit-svm-rbf-dom-rted.sav",
                "trained_classifiers/within-apps-pagekit-svm-rbf-visual-pdiff.sav"],
    'petclinic': ["trained_classifiers/within-apps-petclinic-svm-rbf-doc2vec-distance-content-tags.sav",
                  "trained_classifiers/within-apps-petclinic-svm-rbf-dom-rted.sav",
                  "trained_classifiers/within-apps-petclinic-svm-rbf-visual-pdiff.sav"],
    'phoenix': ["trained_classifiers/within-apps-phoenix-svm-rbf-doc2vec-distance-content-tags.sav",
                "trained_classifiers/within-apps-phoenix-svm-rbf-dom-rted.sav",
                "trained_classifiers/within-apps-phoenix-svm-rbf-visual-pdiff.sav"],
    'ppma': ["trained_classifiers/within-apps-ppma-svm-rbf-doc2vec-distance-content-tags.sav",
             "trained_classifiers/within-apps-ppma-svm-rbf-dom-rted.sav",
             "trained_classifiers/within-apps-ppma-svm-rbf-visual-pdiff.sav"],
}

OUTPUT_CSV = True
filename = 'csv_results_table/rq2-org-within-apps.csv'
